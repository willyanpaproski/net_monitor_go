...
export default function UptimeCard({ uptime }: UptimeCardProps) {
    const [currentUptime, setCurrentUptime] = useState<UptimeData>({ days: 0, hours: 0, minutes: 0, seconds: 0 });
    ...
    const getUptimeStatus = () => {
        ...
        if (totalHours < 168) return { text: 'Running This Week', color: 'success' };
